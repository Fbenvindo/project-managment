...
import { Comercial, Usuario } from "@/api/entities";
            ...
            <div>
              ...
              <div className="mt-3 flex items-center gap-2">
                <button
                  ...
                  className={`px-3 py-1 rounded ${activeTab === 'list' ? 'bg-purple-600 text-white' : 'bg-white border border-gray-200 text-gray-700'}`}
                >Lista</button>
                <button
                  onClick={() => setActiveTab('summary')}
                  className={`px-3 py-1 rounded ${activeTab === 'summary' ? 'bg-purple-600 text-white' : 'bg-white border border-gray-200 text-gray-700'}`}
