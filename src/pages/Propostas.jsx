                  ...
                  {propostas.length === 0 ? (
                    ...
                    <div className="text-center py-12">
                      <div className="grid grid-cols-2 gap-4 items-center mb-2">
                        ...
                        <div className="text-right">R$ {formatCurrency(resumoMensal[0]?.byStatus?.aprovado?.bim || 0)}</div>
                      </div>
                      <div className="grid grid-cols-2 gap-4 items-center mb-2">
                        <div className="text-left">Não aprovados: {resumoMensal[0]?.byStatus?.reprovado?.count || 0}</div>
                        <div className="text-right">R$ {formatCurrency(resumoMensal[0]?.byStatus?.reprovado?.cad || 0)}</div>
                      </div>
