...
const ActivityItem = ({ plano, dayKey, onDelete, onUpdate, executorMap, allPlanejamentos, provided, isDragging, isReprogramando, isSelected, onToggleSelect, hasSelections }) => {
  ...
  // Para atividades rápidas: usar horas executadas do dia se tiver, senão usar total
  ...
  // Para atividades normais: apenas contar horas que têm data específica registrada
  else {
